//Only changes date for first item, but not the other items

$(function(){
	$("#project_daypart").click(function(){
...
$(function(){
	$(".project_date_start").change(function(){
...
$(function(){
	$(".project_date_end").change(function(){
